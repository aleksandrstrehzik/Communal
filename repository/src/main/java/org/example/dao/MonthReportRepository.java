...
public interface MonthReportRepository extends JpaRepository<MonthReport, Integer> {
    ...
    List<MonthReport> findAllByConsumer_IdAndMonth(Integer id, Months month);

    List<MonthReport> findAllByConsumer_IdAndYear(Integer id, Integer year);

    List<MonthReport> findAllByConsumer_IdAndYearAndMonth(Integer id, Integer year, Months month);
